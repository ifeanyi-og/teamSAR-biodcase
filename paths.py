...
RAW_DATA_DIR = DATA_DIR / "01_raw"    # would rather not move 5GB of data around on my PC    
CLIPS_DIR = RAW_DATA_DIR / "clips"    # changed path to raw data ins 

# CLIPS_DIR = Path('/mnt/c/Users/ifean/Documents/SAR_Lab/BIODCASE/Development_Set')
